...
export default function SignUpPage() {
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            console.error("Gagal mendaftar dengan Google:", err)
            setError('Gagal mendaftar menggunakan Google. Silakan coba lagi.')
    ...
    return (
        <section className="flex min-h-screen bg-zinc-50 px-4 py-8 md:py-16 dark:bg-transparent relative">
            ...
            <form
                ...
                className="bg-muted m-auto h-fit w-full rounded-md max-w-sm overflow-hidden border shadow-md shadow-zinc-950/5 dark:[--color-muted:var(--color-zinc-900)]">
                <div className="bg-card -m-px border p-8 pb-6">
                    <div className="text-center">
                        <h1 className="mb-1 text-xl font-semibold">Daftar Akun LapakKilat</h1>
                        <p className="text-sm text-gray-500">Selamat datang! Buat akun untuk memulai</p>
                    </div>
                    ...
                    <div className="mt-6 space-y-6">
                        ...
                        <Button 
                            ...
                            className="w-full py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold transition-colors duration-150 active:scale-95 disabled:opacity-70 flex items-center justify-center">
                            {isLoading ? (
                    ...
                    <div className="my-6 grid grid-cols-[1fr_auto_1fr] items-center gap-3">
                        ...
                        <span className="text-muted-foreground text-xs text-gray-500">Atau daftar dengan</span>
                        <hr className="border-dashed border-gray-200" />
                    </div>
